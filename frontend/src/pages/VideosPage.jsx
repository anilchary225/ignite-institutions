    ...
    <>
      ...
      <section className="bg-neutral-950 py-20">
        <div className="px-6 lg:px-10">
          ...
          <div
            ref={trackRef}
            className="mx-auto mt-8 flex max-w-[1440px] gap-4 overflow-x-auto pb-4 scrollbar-hide"
          ...
          {/* Mobile scroll hint */}
          <p className="mx-auto mt-2 max-w-[1440px] text-center text-xs text-neutral-600 sm:hidden">
            ← Swipe to explore →
          </p>
        </div>
      </section>
