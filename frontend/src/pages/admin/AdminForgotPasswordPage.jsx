...
export default function AdminForgotPasswordPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    setMessage("");
    try {
      const result = await adminRequest("/admin/forgot-password", { method: "POST", body: JSON.stringify({ email }) });
          ...
          <div className="relative flex h-full flex-col justify-between p-8 xl:p-12">
            ...
            <div className="max-w-md">
              <p className="text-2xl font-extrabold leading-[1.15] text-white xl:text-3xl">
                Lost access? We'll help you get back into your account safely.
              </p>
        ...
        <div className="flex flex-col justify-center px-5 py-12 sm:px-8 sm:py-16 md:px-12 lg:px-16 xl:px-20">
          <div className="mx-auto w-full max-w-sm">
            ...
            <p className="mt-2 text-sm text-neutral-500 dark:text-neutral-400">
              {loading ? "Sending your reset link..." : "Enter the admin email address. If the account exists, a reset link is sent."}
            </p>
