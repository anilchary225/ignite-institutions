...
const highlights = [
  { color: "emerald", icon: "🎯", title: "Focused NEET Coaching",           desc: "Covering core concepts and exam strategies aligned to NTA's NEET pattern." },
...
const colorMap = {
  emerald: "border-emerald-200 bg-emerald-50 dark:border-emerald-900/50 dark:bg-emerald-950/20",
...
const phases = [
  { phase: "Phase 1", label: "NCERT Foundations",    period: "Class 11 · Term 1", color: "emerald", items: ["Full Biology (Botany + Zoology)", "Physics mechanics & optics basics", "Basic Organic & Inorganic Chemistry", "Board syllabus coverage", "Weekly chapter MCQ tests"] },
...
const phaseColors = {
  emerald: { badge: "bg-emerald-600 text-white", check: "text-emerald-500" },
  ...
  return (
    <section id="program" className="bg-neutral-50 px-6 py-20 dark:bg-neutral-900/40">
      <div className="mx-auto max-w-7xl">
        ...
        {/* closing statement */}
        <div className="mt-10 rounded-3xl bg-gradient-to-br from-emerald-600 to-indigo-700 p-8 text-center">
          ...
          <a href="#contact" className="mt-6 inline-flex items-center rounded-xl bg-white px-7 py-3.5 text-sm font-black text-emerald-700 transition hover:bg-emerald-50">
            Take the Next Step →
          </a>
        </div>
      </div>
