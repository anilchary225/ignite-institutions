    ...
    <section className="relative overflow-hidden bg-black dark:bg-neutral-800 px-6 py-14">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-6 text-center md:flex-row md:justify-between md:text-left">
        ...
        <div className="flex shrink-0 flex-col gap-3 sm:flex-row">
          <a href="#contact" className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-7 py-4 text-sm font-black text-green-700 shadow-lg transition hover:bg-amber-400 hover:text-white">
