    ...
    <section className="relative overflow-hidden bg-gradient-to-r from-emerald-700 via-teal-600 to-indigo-700 px-6 py-14">
      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center gap-6 text-center md:flex-row md:justify-between md:text-left">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-emerald-200">Your medical career awaits</p>
            <h2 className="mt-1 text-3xl font-extrabold text-white sm:text-4xl">Start Your NEET Journey at Ignite</h2>
          </div>
        </div>

        <div className="flex shrink-0 flex-col gap-3 sm:flex-row">
          <a href="#contact" className="inline-flex items-center justify-center gap-2 rounded-xl bg-white px-7 py-4 text-sm font-black text-emerald-700 shadow-lg transition hover:bg-amber-400 hover:text-white">
            Apply Now <ArrowRight size={16} />
          </a>
          <a href="tel:+919876543210" className="inline-flex items-center justify-center gap-2 rounded-xl border-2 border-white/30 bg-white/10 px-7 py-4 text-sm font-bold text-white backdrop-blur-sm transition hover:bg-white/20">
            Call: +91 98765 43210
          </a>
        </div>
      </div>
