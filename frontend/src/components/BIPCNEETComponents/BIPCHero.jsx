  ...
  return (
    <section className="relative overflow-hidden bg-linear-to-br from-indigo-950 via-indigo-900 to-emerald-950 px-6 pt-16 pb-20">
      ...
      <motion.div
        ...
        className="pointer-events-none absolute -right-20 top-1/2 h-80 w-80 rounded-full bg-indigo-500/10 blur-3xl"
      />
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          >
            ...
            >
              {subjects.map(({ icon: Icon, label, sub, color }) => (
                <motion.div
                  ...
                  className={`flex flex-col items-center gap-2 rounded-2xl border px-3 py-4 text-center ${colorMap[color]}`}
                >
                  <Icon size={20} />
                  <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <motion.a
                ...
                whileTap={{ scale: 0.96 }}
                href="#contact"
                className="inline-flex items-center gap-2 rounded-xl bg-emerald-500 px-6 py-3.5 text-sm font-black text-white shadow-lg shadow-emerald-500/25 transition hover:bg-emerald-400"
              >
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="relative flex flex-col justify-between gap-5 rounded-3xl bg-indigo-950/20 p-5 backdrop-blur-sm"
          >
            ...
            <motion.div
              ...
              className="absolute -left-5 top-8 rounded-2xl bg-white px-4 py-3 shadow-xl dark:bg-neutral-900"
            >
            ...
            <motion.div
              ...
              className="absolute -right-5 top-32 rounded-2xl bg-white px-4 py-3 shadow-xl dark:bg-neutral-900"
            >
            ...
            <div className="inset-x-4 bottom-4 rounded-t-2xl bg-white/90 p-5 backdrop-blur-sm dark:bg-neutral-900/90">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                href="#contact"
                className="mt-3 inline-flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 py-3 text-sm font-black text-white transition hover:bg-emerald-700"
              >
