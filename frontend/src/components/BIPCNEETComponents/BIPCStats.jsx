...
export default function BIPCStats() {
  return (
    <section data-aos="fade-up" className="bg-white px-6 py-12 dark:bg-neutral-950">
      <div className="mx-auto max-w-7xl">
        <div className="rounded-3xl bg-linear-to-br from-emerald-600 via-teal-600 to-indigo-700 p-1 shadow-xl">
