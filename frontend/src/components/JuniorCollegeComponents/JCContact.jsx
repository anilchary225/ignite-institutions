      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            {/* quick facts */}
            <div data-aos="fade-in" className="mt-10 rounded-2xl bg-orange-600 p-6 text-white">
              <p data-aos="fade-up" className="text-xs font-bold uppercase tracking-widest text-orange-200">
              ...
              <ul className="mt-4 space-y-2.5">
                {[
                  ...
                  <li data-aos="fade-up" key={f} className="flex items-start gap-2.5 text-sm">
          ...
          {/* right - form */}
          <div data-aos="fade-up" className="rounded-3xl bg-white p-8 shadow-sm ring-1 ring-neutral-100 dark:bg-neutral-900 dark:ring-neutral-800">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} noValidate className="space-y-5">
                ...
                <button
                  ...
                  type="submit"
                  disabled={submitting}
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-orange-600 px-6 py-3.5 text-sm font-black text-white transition hover:bg-orange-700 active:scale-[0.98]"
                >
