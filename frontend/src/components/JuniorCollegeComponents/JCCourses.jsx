...
function CourseCard({ course }) {
  const c = colorMap[course.color] || colorMap.orange;
  return (
    <motion.div
      variants={cardReveal}
      whileHover={{ y: -6, transition: { duration: 0.25 } }}
      className="flex flex-col rounded-3xl bg-white shadow-sm ring-1 ring-neutral-100 transition hover:shadow-2xl dark:bg-neutral-900 dark:ring-neutral-800"
    >
      <div className="p-7">
...
export default function JCCourses() {
  return (
    <section id="courses" className="bg-white px-6 pb-20 dark:bg-neutral-950 overflow-hidden">
      {/* admissions open strip */}
      <motion.div
        initial={{ opacity: 0, y: -20 }}
        whileInView={{ opacity: 1, y: 0 }}
        viewport={defaultViewport}
        className="w-full bg-linear-to-r from-orange-600 via-indigo-600 to-orange-700 py-4"
      >
