...
/**
 * CampusHostelPage — content-only sections for the ignite.academy
 * "Campus Hostel Facility" page. No navbar/footer.
 *
 * Third distinct visual language in this series: a clip-path wipe hero,
 * a circular "detail inset" image treatment for the bunk-bed shot, and a
 * plain text-wipe closing banner (no timeline, no gradient) — kept
 * different from both the Personality Development and Day At IGNITE pages.
 */
