...
const outcomes = [
  ...
  { icon: TrendingUp,title: "Average Score Jump of 65+ Marks",      stat: "+65 marks", statLabel: "Average improvement",          desc: "Students who join with 630–650 consistently exit with 700+ scores. The daily mock regimen is the primary driver of this jump.", color: "emerald"  },
  ...
  { icon: BookOpen,  title: "Board Performance Maintained",          stat: "90%",       statLabel: "Score 80%+ in boards",         desc: "NEET and board syllabi overlap heavily at Class 12. Our calendar ensures both targets are hit - no compromises.", color: "emerald"  },
  ...
  { icon: Star,      title: "Personalised Dropper Re-Analysis",      stat: "Free",      statLabel: "For dropper students",         desc: "Droppers get a free performance audit of their previous NEET attempt - every wrong answer mapped to a chapter gap before coaching begins.", color: "emerald"  },
...
const colorMap = {
  ...
  emerald: { card: "bg-emerald-50 border-emerald-200 dark:bg-emerald-950/10 dark:border-emerald-900",icon: "bg-emerald-100 text-emerald-600 dark:bg-emerald-950/30 dark:text-emerald-400", stat: "text-emerald-600 dark:text-emerald-400" },
};
