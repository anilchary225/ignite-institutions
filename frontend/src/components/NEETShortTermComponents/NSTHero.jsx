          ...
          >
            ...
            >
              {[
                ...
                <motion.div
                  key={item}
                  variants={fadeUp}
                  className="flex items-start gap-2.5 rounded-xl bg-green-50 px-4 py-3 text-sm text-neutral-700 dark:bg-green-950/10 dark:text-neutral-300"
                >
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <motion.a
                ...
                whileTap={{ scale: 0.96 }}
                href="#apply"
                className="inline-flex items-center gap-2 rounded-xl bg-linear-to-r from-green-500 to-green-500 px-7 py-3.5 text-sm font-black text-white shadow-lg shadow-green-200 transition hover:from-green-600 hover:to-green-600 dark:shadow-green-900/30"
              >
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.96 }}
                href="#course"
                className="inline-flex items-center gap-2 rounded-xl border border-neutral-200 bg-white px-6 py-3.5 text-sm font-bold text-neutral-700 transition hover:border-green-300 hover:text-green-700 dark:border-neutral-700 dark:bg-neutral-900 dark:text-neutral-300"
              >
                View Schedule
              </motion.a>
            </div>
          ...
          >
            ...
            <div className="mt-3 flex items-center justify-between rounded-2xl border border-green-200 bg-green-50 px-5 py-4 dark:border-green-900/40 dark:bg-green-950/20">
              ...
              <motion.a
                ...
                whileTap={{ scale: 0.96 }}
                href="#apply"
                className="shrink-0 rounded-xl bg-green-500 px-4 py-2.5 text-xs font-black text-white transition hover:bg-green-600"
              >
                Reserve Seat
              </motion.a>
            </div>
