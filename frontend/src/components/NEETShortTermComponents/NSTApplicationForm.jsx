        ...
        <input
          ...
          className={`w-full rounded-xl border py-3 text-sm text-neutral-950 placeholder-neutral-400 outline-none transition focus:ring-2 dark:bg-neutral-950 dark:text-white dark:placeholder-neutral-600
            ...
            ${error
              ...
              : "border-neutral-200 bg-white focus:border-green-400 focus:ring-green-100 dark:border-neutral-700 dark:bg-neutral-950 dark:focus:ring-green-900/30"
            }`}
        />
      </div>
      ...
      <div className="relative">
        ...
        <select
          ...
          className={`w-full appearance-none rounded-xl border py-3 text-sm text-neutral-950 outline-none transition focus:ring-2 dark:bg-neutral-950 dark:text-white
            ...
            ${error
              ? "border-rose-400 focus:border-rose-400 focus:ring-rose-100"
              : "border-neutral-200 bg-white focus:border-green-400 focus:ring-green-100 dark:border-neutral-700 dark:focus:ring-green-900/30"
            }`}
        >
...
export default function NSTApplicationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await submitEnquiry({ category: "neet-short-term", source: "neet-short-term-form", payload: form });
      setStatus("success");
    } catch {
      setStatus("error");
    }
