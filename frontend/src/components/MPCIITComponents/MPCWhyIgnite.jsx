...
const colorMap = {
  blue:  { bg: "bg-blue-600", light: "bg-blue-50 dark:bg-blue-950/20", border: "border-blue-100 dark:border-blue-900/40 hover:border-blue-500 dark:hover:border-blue-500", text: "text-blue-600 dark:text-blue-400" },
  indigo:  { bg: "bg-indigo-600", light: "bg-indigo-50 dark:bg-indigo-950/20", border: "border-indigo-100 dark:border-indigo-900/40 hover:border-indigo-500 dark:hover:border-indigo-500", text: "text-indigo-600 dark:text-indigo-400" },
  sky:     { bg: "bg-sky-500",    light: "bg-sky-50 dark:bg-sky-950/20",       border: "border-sky-100 dark:border-sky-900/40 hover:border-sky-500 dark:hover:border-sky-500",         text: "text-sky-600 dark:text-sky-400" },
  emerald: { bg: "bg-emerald-600",light: "bg-emerald-50 dark:bg-emerald-950/20",border:"border-emerald-100 dark:border-emerald-900/40 hover:border-emerald-500 dark:hover:border-emerald-500",  text: "text-emerald-600 dark:text-emerald-400" },
  amber:   { bg: "bg-amber-500",  light: "bg-amber-50 dark:bg-amber-950/20",   border: "border-amber-100 dark:border-amber-900/40 hover:border-amber-500 dark:hover:border-amber-500",     text: "text-amber-600 dark:text-amber-400" },
};
