      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-8 space-y-5">
              {[
                ...
                <div data-aos="fade-up" key={title} className="flex items-start gap-4">
            ...
            {/* CTA card */}
            <div data-aos="fade-in" className="mt-10 rounded-3xl bg-linear-to-br from-green-600 to-green-700 p-7 text-white">
              <p data-aos="fade-up"  className="text-xs font-bold uppercase tracking-widest text-green-200">Free Offer</p>
              <h3 data-aos="fade-up" className="mt-2 text-xl font-extrabold">Scholarship Test</h3>
              <p data-aos="fade-up" className="mt-2 text-sm leading-6 text-green-200">
              ...
              <a data-aos="fade-up" href="/contact" className="mt-5 inline-flex items-center rounded-xl bg-white px-5 py-2.5 text-sm font-bold text-green-700 hover:bg-green-50 transition">
          ...
          <div className="rounded-3xl bg-neutral-50 p-8 ring-1 ring-neutral-100 dark:bg-neutral-900 dark:ring-neutral-800">
            {submitted ? (
              <div data-aos="zoom-in" className="flex h-full flex-col items-center justify-center gap-4 py-10 text-center">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <h3 data-aos="fade-left" className="text-xl font-extrabold text-neutral-950 dark:text-white">
