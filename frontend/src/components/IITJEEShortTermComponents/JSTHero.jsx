...
const rankers = [
  { name: "Vivaan Shah",   rank: "AIR 52",  score: "99.97%ile", exam: "JEE Main",     college: "IIT Bombay", color: "from-amber-500 to-orange-600" },
  { name: "Ananya Iyer",  rank: "AIR 118", score: "99.93%ile", exam: "JEE Advanced",  college: "IIT Delhi",  color: "from-orange-500 to-red-500" },
  { name: "Karan Gupta",  rank: "AIR 234", score: "99.88%ile", exam: "JEE Main",      college: "NIT Warangal",color: "from-yellow-500 to-amber-600"},
  { name: "Preethi Rao",  rank: "AIR 87",  score: "99.95%ile", exam: "JEE Advanced",  college: "IIT Madras", color: "from-amber-600 to-yellow-500" },
];
        ...
        <div className="grid items-start gap-14 lg:grid-cols-[1fr_420px]">
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#apply" className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 px-7 py-3.5 text-sm font-black text-white shadow-lg shadow-amber-200 transition hover:from-amber-600 hover:to-orange-600 dark:shadow-amber-900/30">
